...
// navigation and animation button code
  ...
  void initState() {
    ...
    widget.id!=null?selectedperson=widget.person.toString():"";
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Container(
                      child:  Text("Taxi Booking",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25,color: Color(0xff4c505b)),),
                    ),
                  ),
                  SizedBox(
                    height: 10.0,
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: DropdownButtonFormField2(
                                ...
                                onChanged: (newvalue) {
                                  setState(() {
                                    selectedperson = newvalue.toString();
                                  });
                                },
                                items: _locations
                                    .map((location) =>
                            ...
                            InkWell(
                              ...
                              child: AnimatedContainer(
                                ...
                                child:changebutton? Icon(Icons.done,color: Colors.black,):Text(widget.id==null?"Submit":"Update",style: TextStyle(
                                    color: Colors.black,
  ...
  Submit() async{
    ...
    if(_formkey.currentState!.validate()){
      try{
        ...
        if(widget.id ==null){
          await FirebaseFirestore.instance.collection("taxibook").add({
            'name': username.text,
            'age': age.text,
          ...
          await FirebaseFirestore.instance.collection("taxibook").doc(widget.id).update({
            'name': username.text,
            'age': age.text,
            'mobileno':number.text,
            'gender':selectedGender,
